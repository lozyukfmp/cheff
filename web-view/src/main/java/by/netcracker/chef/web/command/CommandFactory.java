...
import by.netcracker.chef.web.command.impl.menu.*;
import by.netcracker.chef.web.command.impl.EmptyCommand;
import by.netcracker.chef.web.command.impl.GetIndexPageCommand;
import by.netcracker.chef.web.command.impl.salad.*;
import by.netcracker.chef.web.command.impl.vegetable.*;
